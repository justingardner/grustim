...
stimulus.dots.speed = 7.5;
stimulus.dots.coherence = [0.6 0.6];
stimulus.dots.n = 600;
stimulus.dots.dir = 0;
stimulus.dots.stencilPos = 1+myscreen.imageWidth/4;
stimulus.dots.stencilWidth = myscreen.imageWidth/2;
...
% set up task
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
task{2}{1}.parameter.coherence = [0 1;1 0];
task{2}{1}.random = 0;
...
mglFillRect(xpos+stimulus.dots.stencilWidth/2,ypos,stencilSize);
...
% set direction of dots
stimulus.dots.dir = rand(1,2)*2*pi;
