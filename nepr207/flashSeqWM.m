...
task{1}{1}.segmin = [0.9, repmat([0.4,0.2],1,stimulus.maxSequence), 12, 5, 1]; % average trial time = 25s
task{1}{1}.segmax = [0.9, repmat([0.4,0.2],1,stimulus.maxSequence), 12, 5, 6];
