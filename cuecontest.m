...
function myscreen = cuecontest(varargin)
...
if taskType == 1
  ...
  if training > 0
      if training == 1 || training == 2 % training 1 and 2 is slow
        task{1}{2}.segmin = [1 5 0.3 5 2.5 1];
        task{1}{2}.segmax = [1 5 0.3 5 2.5 1];
