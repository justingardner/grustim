...
task{1}.segmin = [inf, stimulus.stimLen, 0.2, 5.0, 0.2];
task{1}.segmax = [inf, stimulus.stimLen, 0.2, 5.0, 0.2];
stimulus.seg = {};
stimulus.seg.fix = 1;
...
task{1}.randVars.calculated.nonmatch_partlocation = NaN;
task{1}.randVars.calculated.nonmatch_partstructure = NaN;
...
task.thistrial.nonmatch_structure = task.thistrial.sample_structure;
task.thistrial.nonmatch_partlocation = task.thistrial.sample_partlocation;
task.thistrial.nonmatch_partstructure = task.thistrial.sample_partstructure;
...
stimulus.live.match_image = stimulus.live.stims.(sprintf('img%s_%i%i%i%i_v%i', base_seed, task.thistrial.sample_surface, task.thistrial.sample_structure, task.thistrial.sample_partlocation, task.thistrial.sample_partstructure, task.thistrial.match_view));
stimulus.live.nonmatch_image = stimulus.live.stims.(sprintf('img%s_%i%i%i%i_v%i', base_seed, task.thistrial.nonmatch_surface, task.thistrial.nonmatch_structure, task.thistrial.nonmatch_partlocation, task.thistrial.nonmatch_partstructure, task.thistrial.nonmatch_view));

stimulus.live.eyeCount = 0;

% Disp trial parameters each trial
fprintf('Trial %d - BaseSeed = %s. Condition=%s, Sample/Match = %i%i%i%i, Non-Match = %i%i%i%i', task.trialnum, base_seed, stimulus.conditions{task.thistrial.nonmatch_dimension}, task.thistrial.sample_surface, task.thistrial.sample_structure, task.thistrial.sample_partlocation, task.thistrial.sample_partstructure, task.thistrial.nonmatch_surface, task.thistrial.nonmatch_structure, task.thistrial.nonmatch_partlocation, task.thistrial.nonmatch_partstructure);
