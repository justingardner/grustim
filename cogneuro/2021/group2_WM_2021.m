...
task{1}.segmin = [0.1 0.2 0.4 0.2 0.4 0.8 stimulus.delayInterval 0.5 2.5];
task{1}.segmax = [0.1 0.2 0.4 0.2 0.4 0.8 stimulus.delayInterval 0.5 2.5];
stimulus.seg = {};
stimulus.seg.ready = 1;
stimulus.seg.stim1 = 2;
stimulus.seg.isi1 = 3;
stimulus.seg.stim2 = 4;
stimulus.seg.isi2 = 5;
stimulus.seg.cue = 6;
stimulus.seg.delay = 7;
stimulus.seg.stim3 = 8;
stimulus.seg.resp = 9;
...
task{1}.getResponse = [0 0 0 0 0 0 0 0 1];
...
elseif task.thistrial.thisseg == stimulus.seg.stim3
  % put up match either clockwise or counterclockwise 
  mglBltTexture(stimulus.tex,[0 0],0,0,stimulus.matchOrientation);
elseif task.thistrial.thisseg == stimulus.seg.ready
  mglBltTexture(stimulus.readyText, [0,1.5], 0,0,0);
end  
...
stimulus.readyText = mglText('ready');
